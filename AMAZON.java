...
//		  List<WebElement> mobile = driver.findElements(By.xpath("//div[@class='sg-col-20-of-24 s-matching-dir sg-col-16-of-20 sg-col sg-col-8-of-12 sg-col-12-of-16']"));
		  List<WebElement> mobile = driver.findElements(By.xpath("//span[@class='a-price-whole''a-size-medium a-color-base a-text-normal']"));
//		  driver.findElements(By.xpath("//span[@class='a-price-whole']"));
//		  driver.findElement(By.xpath("//span[class='a-size-medium a-color-base a-text-normal']"));
//		  System.out.println()
		  TakesScreenshot ts=(TakesScreenshot)driver;
          File source=ts.getScreenshotAs(OutputType.FILE);
          File appu=new File("./praveen/img.png");
          FileHandler.copy(source,appu);
